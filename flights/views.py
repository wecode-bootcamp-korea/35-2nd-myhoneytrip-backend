    ...
    def get(self, request):
        try:
                ...
                departure_info = [{
                        ...
                        'arrivel_time'               : departure_option.arrival_time.strftime('%H:%M'),
                        'flight_time'                : ':'.join(str(departure_option.arrival_time-departure_option.departure_time).split(':')[:2]),
                ...
                return_info = [{
                        ...
                        'arrivel_time'               : return_option.arrival_time.strftime('%H:%M'),
                        'flight_time'                : ':'.join(str(return_option.arrival_time - return_option.departure_time).split(':')[:2]),
